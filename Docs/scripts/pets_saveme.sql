...
DROP INDEX IF EXISTS LOCAALIZATIONHISTORY_FK CASCADE;
DROP  INDEX IF EXISTS PICTUREPLACES_FK CASCADE;
DROP  INDEX IF EXISTS HISTORY_PLACE_PK CASCADE;
...
DROP  TABLE IF EXISTS users.APP_USER CASCADE;
